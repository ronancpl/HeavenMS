...
public final class MoveLifeHandler extends AbstractMovementPacketHandler {
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        short StartPosX = slea.readShort();
        short StartPosY = slea.readShort();
        
        Point startPos = new Point(StartPosX, StartPosY);
        ...
        if (toUse != null) {
            ...
            c.announce(MaplePacketCreator.moveMonsterResponse(objectid, moveid, monster.getMp(), aggro, 0, 0));
        }
        if (aggro) {
